                ...
                <table class="w-full">
                    <thead class="bg-slate-700/30">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">CI</th>
                            <th class="px-6 py-4 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">Rol</th>
                            <th class="px-6 py-4 text-right text-xs font-medium text-slate-400 uppercase tracking-wider">Acciones</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-white/5">
                        <tr v-for="user in users" :key="user.id" class="hover:bg-white/5 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <button
                                    v-if="user.role?.name !== 'tenant_admin'"
        ...
        <Teleport to="body">
            <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div class="relative w-full max-w-sm bg-slate-900 border border-white/10 rounded-2xl shadow-2xl p-6 text-center">
                    ...
                    <p class="text-slate-400 mb-6">Se eliminará a <span class="text-white font-medium">{{ userToDelete?.name }}</span></p>
