        ...
        <aside :class="[showingSidebar ? 'translate-x-0' : '-translate-x-full']"
            ...
            <div class="relative flex h-full flex-col">
                ...
                <div class="flex-shrink-0 flex h-16 items-center gap-3 border-b border-white/10 px-4">
                    <div
                        class="h-10 w-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
                ...
                <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                    <template v-for="item in navigation" :key="item.name">
                        <Link v-if="route().has(item.href)" :href="route(item.href)" :class="[
                            ...
                            <!-- Business Icon -->
                            <svg v-if="item.icon === 'business'" class="h-5 w-5 flex-shrink-0" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-shrink-0 border-t border-white/10 p-3">
                    <div class="relative">
                        <button @click="showUserMenu = !showUserMenu"
                            ...
                            <div
                                class="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex-shrink-0">
